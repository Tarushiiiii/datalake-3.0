...
//   const createProjectFromAttendance = useProjectStore(
//     (s) => s.createProjectFromAttendance,
//   );
...
export default function GetLocation() {
  const setCurrentSiteName = useAttendanceStore((s) => s.setCurrentSiteName);
  // Removed: createProjectFromAttendance — projects are created on check-in in attendance-camera.tsx
